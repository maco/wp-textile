				    ...
				    <div id="main" class="eightcol first clearfix" role="main">
					    ...
					    <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						    ...
						    <header class="article-header">
							    ...
							    <p class="byline vcard"><?php _e('Posted', 'textiletheme'); ?> <time class="updated" datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time(get_option('date_format')); ?></time> <?php _e('by', 'textiletheme'); ?> <span class="author"><?php the_author_posts_link(); ?></span> <span class="amp">&</span> <?php _e('filed under', 'textiletheme'); ?> <?php the_category(', '); ?>.</p>
					    ...
					    <?php else : ?>
					        ...
					        <article id="post-not-found" class="hentry clearfix">
					        	...
					        	<footer class="article-footer">
					        	    <p><?php _e("This is the error message in the index.php template.", "textiletheme"); ?></p>
					        	</footer>
					        </article>
